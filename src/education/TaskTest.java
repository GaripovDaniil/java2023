...
class TaskTest {
    ...
    void checkingTaskCreationName() {
        var task = new Task.TaskBuilder().subjectName("Программирование").numberOfTask(1).markForTask(5).build();
    ...
    void changeMarkIsCorrect() {
        var task = new Task.TaskBuilder().subjectName("Программирование").numberOfTask(1).markForTask(3).build();
